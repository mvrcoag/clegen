...
* Uses NestJS with Fastify adapter for high-performance HTTP handling.
*
* @description Handles HTTP requests for {{ entity }} CRUD operations.
* Fastify adapter provides ~2x performance improvement over Express.
*
* Note: Ensure @nestjs/platform-fastify is installed and configured in main.ts:
